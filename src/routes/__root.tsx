...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Aperion" },
      { name: "description", content: "Aperion is a biology-first productivity app designed to optimize deep work sessions." },
      { property: "og:description", content: "Aperion is a biology-first productivity app designed to optimize deep work sessions." },
      { name: "twitter:description", content: "Aperion is a biology-first productivity app designed to optimize deep work sessions." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/470d9e36-4d66-471d-8f5a-2aea784c2718/id-preview-d3ec729b--b1b16990-1491-41de-b952-4f13815474d6.lovable.app-1776477748809.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/470d9e36-4d66-471d-8f5a-2aea784c2718/id-preview-d3ec729b--b1b16990-1491-41de-b952-4f13815474d6.lovable.app-1776477748809.png" },
    ],
